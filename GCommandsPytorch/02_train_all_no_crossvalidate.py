# Try to improve score by using 100% of data and skipping cross validation
...
parser.add_argument('--train_path', default='train_data/train', help='path to the train data folder')
parser.add_argument('--test_path', default='train_data/test', help='path to the test data folder')
parser.add_argument('--valid_path', default='train_data/valid', help='path to the valid data folder')
...
parser.add_argument('--optimizer', default='sgd', help='optimization method: sgd | adam')
...
while epoch < args.epochs + 1:
    ...
    if not os.path.isdir('checkpoint'):
        os.mkdir('checkpoint')
    torch.save(state, './checkpoint/ckpt_model_all.t7')
    epoch += 1
